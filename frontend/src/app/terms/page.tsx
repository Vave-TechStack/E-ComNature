    ...
    <div className="min-h-screen bg-natural">
      ...
      <div className="container-custom py-8 md:py-12">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-3xl mx-auto">
          ...
          <div className="prose max-w-none space-y-6 text-gray-600 text-sm leading-relaxed">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mt-6">1. Account Registration</h3>
            ...
            <h3 className="text-lg font-semibold text-gray-900">2. Products & Pricing</h3>
            ...
            <h3 className="text-lg font-semibold text-gray-900">3. Orders & Payment</h3>
